...
type FormData = PersonalDetailsInput &
...
export default function NewApplicationPage() {
  ...
  const handleCreateApplication = async () => {
    ...
    try {
      ...
      // Upload documents using the token from the store directly
  ...
  const slideVariants = {
    enter: (_dir: number) => ({ x: 60, opacity: 0 }),
    center: { x: 0, opacity: 1 },
    exit: (_dir: number) => ({ x: -60, opacity: 0 }),
  }
            ...
            return (
              <React.Fragment key={step.id}>
                ...
                {i < APPLICATION_STEPS.length - 1 && (
                  <div
                    className={cn(
                      'h-0.5 flex-1 min-w-[12px] rounded transition-all',
            ...
            {currentStep === 1 && (
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <InputField label="Phone Number" error={step1Form.formState.errors.phone?.message} required hint="e.g. 0712345678">
                ...
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  {step1Form.watch('hasDisability') && (
                    <div className="mt-3">
                      <textarea {...step1Form.register('disabilityNotes')} placeholder="Briefly describe your disability or special needs" rows={2} className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 resize-none" />
                    </div>
                  )}
                </div>
              </div>
            ...
            {currentStep === 2 && (
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <InputField label="Number of Dependents" error={step2Form.formState.errors.dependents?.message} required hint="People supported by household income">
                ...
                <div className="p-4 bg-gray-50 rounded-xl space-y-3">
                  ...
                  {step2Form.watch('isOrphan') && (
                    <InputField label="Orphan Status Details" error={step2Form.formState.errors.orphanStatus?.message}>
                      <input {...step2Form.register('orphanStatus')} placeholder="e.g. Both parents deceased" className={inputClass()} />
                    </InputField>
                  )}
                </div>
              </div>
            ...
            {currentStep === 4 && (
              <div className="space-y-5">
                ...
                <InputField
                  ...
                  error={step4Form.formState.errors.personalStatement?.message}
                  required
                  hint="Min. 100 characters. Describe your financial need and how the bursary will help you."
                >
                  <textarea
                    {...step4Form.register('personalStatement')}
                    rows={5}
                    placeholder="Explain your financial circumstances, why you need this bursary, and what you plan to achieve..."
                    className={cn(
                      'w-full px-4 py-3 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 resize-none transition-all',
              ...
              <div className="space-y-5">
                ...
                <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl">
                  ...
                  <ul className="mt-2 space-y-1 text-amber-700 text-xs">
                    ...
                    <li>• Documents must be PDF, JPEG, or PNG format</li>
                    <li>• Maximum file size is 5 MB per document</li>
